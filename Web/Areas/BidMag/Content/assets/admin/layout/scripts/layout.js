...
var Layout = function () {
    ...
    var windowDimensions = function () { // prototype/jQuery compatible
        ...
        myHeight = myHeight - 135;
        var LeftMenu = $("#LeftMenu").width();
        myWidth = myWidth - (parseInt(LeftMenu) + 20);
        // alert($(".page-content").css("height").replace("px", "") - $(".main-content").css("height").replace("px", ""));
    ...
    var handleSidebarToggler = function () {
        ...
        if ($.cookie && $.cookie('sidebar_closed') === '1' && Metronic.getViewPort().width >= resBreakpointMd) {
            ...
            var dim = Layout.getwindowDimensions();
            var myIframe = $('.iframeContent'); // changed the code to use jQuery

            myIframe.width((dim[0]) + "px");
        }
...
window.onresize = function () {
    var body = $('body');
    var IsClosed = body.hasClass("page-sidebar-closed");
    if (IsClosed) {
        var dim = Layout.getwindowDimensions();
        var myIframe = $('.iframeContent'); // changed the code to use jQuery
        myIframe.height((dim[1]) + "px");
        myIframe.width((parseInt((dim[0])) + 190) + "px");
    }
    else {
        var dim = Layout.getwindowDimensions();
        var myIframe = $('.iframeContent'); // changed the code to use jQuery
