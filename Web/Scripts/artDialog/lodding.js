; (function ($) {
    ...
    $.fn.jqLoading = function (option) {
        ...
        function openLayer() {
            ...
            //图片及文字层
            var content = $("<div id='AjaxSendloading'></div>");
            content.css({
                textAlign: "center",
                position: "absolute",
                zIndex: 9999,
            ...
            content.append("<span style='text-align:center;color:#8E8E8E;line-height:"+opt.height+"px; vertical-align:middle;'>" + opt.text + "</span>");
        ...
        //销毁对象
        function closeLayer() {
            $("#layer,#AjaxSendloading,#partialLayer").remove();
            return this;
        }
