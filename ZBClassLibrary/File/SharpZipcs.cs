...
{
    public static class SharpZipcs
    {
        ...
        public static int Zip(string destFolder, string srcFolder, string password, CompressLevel level, out string error)
        {
            ...
            try
            {
                ...
                count = PutDirectoryToZipStream(srcFolder, null, null, zipStream, crc32, streamWriter);
            }
            catch (Exception e)
            {
                error = e.Message;
        ...
        public static int Zip(string destFolder, string srcFolder, string folderName, string password, CompressLevel level, out string error)
        {
            ZipOutputStream zipStream = null;
            FileStream streamWriter = null;
            error = "正在压缩...";
            ...
            try
            {
                ...
                count = PutDirectoryToZipStream(srcFolder, null, folderName, zipStream, crc32, streamWriter);
            }
            catch (Exception e)
            {
                error = e.Message;
        ...
        public static int Zip(string destFolder, string[] srcFiles, string folderName, string password, CompressLevel level, out string error)
        {
            ZipOutputStream zipStream = null;
            FileStream streamWriter = null;
            error = "正在压缩...";
        ...
        private static int PutDirectoryToZipStream(string directory, string logicBaseDir, string folderName,
                                                 ZipOutputStream zipStream, Crc32 crc32, FileStream streamWriter)
        {
            ...
            {
                var folderNameSrc = directory;
                logicDir = folderNameSrc.Replace(folderName, "");
            }
            ...
            {
                count = count + PutDirectoryToZipStream(dir, logicDir, folderName, zipStream, crc32, streamWriter);
            }
