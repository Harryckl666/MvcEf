...
namespace ZbClassLibrary.DTcms
{
	...
	public class Thumbnail
	{
        ...
        /// <param name="dir">图片所在文件夹路径（绝对路径）</param>
        ...
        /// <param name="dir">保存文件夹位置</param> 
        /// <param name="dFile">保存位置</param> 
        /// <returns></returns>  
        ...
        /// </summary>  
        /// <param name="sFile">原图片</param>  
        /// <param name="dir">压缩后保存文件夹位置</param> 
        /// <param name="dFile">压缩后保存位置</param> 
        /// <param name="cutType">裁剪比例类型0 原图裁剪,1 1:1裁剪,2 4:3裁剪,3 16:9裁剪</param>   
        /// <returns></returns>  
