...
namespace ZbClassLibrary
{
    ...
    public static class TextUtility
    {
        ...
        /// <returns></returns>
        public static string ToEncrypt(this string pToEncrypt, string sKey = Consts.ENCRYPT_DECRYPT_KEY)
        {
        ...
        public static string ToDecrypt(this string pToDecrypt, string sKey = Consts.ENCRYPT_DECRYPT_KEY)
        {
